...
export default function Home() {
  ...
  const contractAddress = "0x1C4E8d2C60213224479B6b865b9370A232900d8f";
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Buy Miguel a Coffee!</title>
        <meta name="description" content="Tipping site" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <main className={styles.main}>
        <h1 className={styles.title}>Buy Miguel a Coffee!</h1>
        ...
        {currentAccount ? (
          <div>
            <form>
              ...
              <br />
              <div>
                <label>Send Miguel a message</label>
                <br />
